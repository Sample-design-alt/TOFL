    ...
    def train(self, tot_epochs, train_loader, train_loader_label, val_loader, test_loader, opt, config):
        ...
        for epoch in range(tot_epochs):
            ...
            for i, (data_augmented, data_P, data_F, _) in enumerate(train_loader):
                ...
                nn.utils.clip_grad_norm_(self.sup_head.parameters(), max_norm=4.0)
                nn.utils.clip_grad_norm_(self.relation_head.parameters(), max_norm=4.0)
                nn.utils.clip_grad_norm_(self.backbone.parameters(), max_norm=4.0)
